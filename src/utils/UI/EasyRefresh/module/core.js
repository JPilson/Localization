(function (window) {
    ...
    var Scroller = function (callback, options) {
        ...
        this.options = {
            ...
            /** Enable scrolling on rules.json-axis */
            scrollingY: true,
    ...
    var members = {
        ...
        */
        ...
        /** {Number} Scroll position on rules.json-axis */
        __scrollTop: 0,

        /** {Integer} Maximum allowed scroll position on x-axis */
        __maxScrollLeft: 0,

        /** {Integer} Maximum allowed scroll position on rules.json-axis */
        __maxScrollTop: 0,
        ...
        */
        ...
        /*triggerPullToRefresh: function() {
            ...
            // We don't need to normalize scrollLeft, zoomLevel, etc. here because we only rules.json-scrolling when pull-to-refresh is enabled
                ...
                if (self.__enableScrollY) {
                    ...
                    if (scrollTop > maxScrollTop || scrollTop < 0) {
                        ...
                        if (self.options.bouncing) {
                            ...
                            // Support pull-to-refresh (only when only rules.json is scrollable)
