<template>
  <div>
<!--    <div class="er-classics-footer-box"-->
...
<!--            <CircularProgress v-if="footerStatus === 4" :color="textColor"-->
<!--                              class="er-classics-footer-progress"></CircularProgress>-->
<!--            <Done v-else-if="footerStatus === 5 || footerStatus === 6" :color="textColor"-->
<!--                  class="er-classics-footer-done-icon"></Done>-->
<!--            <Arrow v-else direction="up" :color="textColor" :rotate="rotateArrow"-->
<!--                   class="er-classics-footer-arrow-icon"></Arrow>-->
<!--        </span>-->
<!--        &lt;!&ndash;文字&ndash;&gt;-->
...
<!--            <div v-if="showMore" :style="'color: ' + moreInfoColor + ';'"-->
<!--                 class="er-classics-footer-content-more">{{ showMoreInfo }}</div>-->
<!--        </span>-->
